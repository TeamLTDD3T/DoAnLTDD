...
class ListDelivering extends StatefulWidget {
  final idTaiKhoan;
  const ListDelivering(this.idTaiKhoan, {Key? key}) : super(key: key);

  @override
  _ListDeliveringState createState() => _ListDeliveringState();
}

class _ListDeliveringState extends State<ListDelivering> {
  @override
                ...
                ? Column(
                    children: <Widget>[
                      ...
                      for (var i = 0; i < snapshot.data!.length; i++)
                        if (snapshot.data![i].trangThai == 2)
                          Row(
                            children: [
                              Column(
