...
class ListCancel extends StatefulWidget {
  final idTaiKhoan;
  const ListCancel(this.idTaiKhoan, {Key? key}) : super(key: key);

  @override
  _ListCancelState createState() => _ListCancelState();
}

class _ListCancelState extends State<ListCancel> {
  @override
