...
class FormReviewed extends StatefulWidget {
  final idTaiKhoan;
  const FormReviewed(
    this.idTaiKhoan, {
    Key? key,
  ...
  @override
  _FormReviewedState createState() => _FormReviewedState();
}

class _FormReviewedState extends State<FormReviewed> {
